      ...
      <main className="relative max-w-7xl mx-auto px-6 py-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {category.resources.map((resource, resourceIndex) => (
                    <motion.div
                      ...
                      className="bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-lg p-4 hover:border-gray-600 transition-all group cursor-pointer"
                    >
                      ...
                      <div className="flex items-center gap-4 text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <div className="px-2 py-0.5 bg-gray-200 dark:bg-gray-800 rounded text-xs">
                          {resource.type === "video"
                            ? "Video"
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Oradores de Referencia</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {inspirationalSpeakers.map((speaker, index) => (
              <motion.div
                ...
                className="bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-lg p-5 hover:border-yellow-500/50 transition-all group"
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-bold text-gray-900 dark:text-white mb-1 group-hover:text-yellow-400 transition-colors">
                      {speaker.name}
                    </h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">{speaker.topic}</p>
